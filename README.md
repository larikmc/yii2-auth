...
Модуль предназначен для использования на нескольких проектах и позволяет иметь **одну авторизацию, один дизайн и одну логику безопасности**, обновляемые через Composer.
...
- 🛡 Защита от брутфорса:
    - лимиты по IP + UserAgent
    - лимиты по пользователю
    - экспоненциальная задержка
- 🤖 Honeytoken (скрытое поле против ботов)
- 🧩 CAPTCHA после N попыток
- ⏱ Блокировка входа с таймером
